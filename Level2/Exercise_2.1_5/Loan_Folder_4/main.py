...
def main():
    ...
    # Q&A:
    # Q. What are the benefits of statistic-level methods?
    # A. They are simple: no need for an initialization function nor do you need member data.

    # Q. Why are they useful?
    # A. These are used to group together functions of the same type (e.g. statistical functions) without having to create individual modules and directories for them.
