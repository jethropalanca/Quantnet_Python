...
Version 2: Fixed the Zero Division Error! Not fixed retroactively. VariableRateLoan won't work as some monthlypay functions were left blank.
Version 3: Added t for each, Fixed Line 181 and changed it to getRate as it cannot take a self._rate
'''
...
class Loan(object):
    ...
    def interestDueRecursive(self, t):
        ...
        if not t:
            ...
            return max(0, mRate * balance) # (Calc to Static 7.) Originally a calculation, Now a Static Method ...
    ...
    def balanceRecursive(self, t):
        ...
        if not t:
            ...
            return self._notional - (payment - Loan.monthlyRate(self.getRate(t)) * self._notional) # (Calc to Static 3.) Originally a calculation, Now a Static Method
        else:
