'''
This program tests the loan pool functions.
'''

from Loan_Folder_10.Loan_Package.Autoloan import autoLoan
from Loan_Folder_10.Loan_Package.loan import Loan
from Loan_Folder_10.Loan_Package.loan_types import VariableRateLoan, FixedRateLoan
from Loan_Folder_10.Loan_Package.Asset import Asset
from Loan_Folder_10.Loan_Package.VariableMortgage import VariableMortgage
from Loan_Folder_10.Loan_Package.FixedMortgage import FixedMortgage
from Loan_Folder_10.Loan_Package.LoanPool import LoanPool

# If from Loan_Package. only, won't work
...
Version 1 Deleted.
    ...
    print('\nLoan Objects:')
    print(lP.getloans())
    loanList = lP.getloans()
    print(len(loanList))

    loanA = Loan(30, 0.05, 100000)
    print(loanA.balance(loanA._term, loanA._rate, loanA._notional, 1))
    ...
    print(finalloanList)
    print(finalloanList[0].balance)
    print(finalloanList[1]._term)
    print(finalloanList[1]._rate)
    print(finalloanList[1]._notional)

    # print(finalloanList[1].balance(finalloanList[1]._term, finalloanList[1]._rate, finalloanList[1]._notional, 1))
    ...
    # Test loanErase Functions
    # lP.loanErase()
    # print(lP.getloans())

    # (2) Set up Loan Principal Collection
    # print('\n\nII. Setting up collection of Principal...')

    # print('\nSetting up collection of Loans...')
    # lP.loanCollectAttr(Loan(30, 0.05, 100000)._notional)

    # print('Setting up collection of Variable Rate Loans...')
    # lP.loanCollectAttr(VariableRateLoan(30, {0: 0.03, 5: 0.05, 11: 0.07}, 100000)._notional)

    # print('\nSetting up collection of Fixed Rate Loans...')
    # lP.loanCollectAttr(FixedRateLoan(30, 0.05, 100000)._notional)

    # print('\nLoan Principals:')
    # results1 = lP.getloanAttr()

    # (3) Set up Loan Balances Collection
    # lP.loanAttrErase()
    # print('\n\nIII. Setting up collection of Balance...')

    # print('\nSetting up collection of Loans...')
    # lP.loanCollectAttr(Loan(30, 0.05, 100000).balance(30, 0.05, 100000, 10))

    # print('Setting up collection of Variable Rate Loans...')
    # lP.loanCollectAttr(VariableRateLoan(30, {0: 0.03, 5: 0.05, 11: 0.07}, 100000).balance(30, 0.05, 100000, 10))

    # print('\nSetting up collection of Fixed Rate Loans...')
    # lP.loanCollectAttr(FixedRateLoan(30, 0.05, 100000).balance(30, 0.05, 100000, 10))

    # print('\nLoan Balance:')
    # results2 = lP.getloanAttr()
