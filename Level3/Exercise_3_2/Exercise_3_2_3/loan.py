'''
PORTED OVER FROM 3_1_2

Unchanged in Folder 10
...
class Loan(object):
    ...
    def totalPayments(self):
        ...
        if not payment:
            ...
            # Edit made per Avi Palley on potential un-even payments
            return sum([self.monthlyPayment(t) for t in range(self._term * 12)])
