...
from Exercise_3_3.Exercise_3_3_4.Loan_Package.asset import Asset
...
class Loan(object):
    ...
    def __init__(self, term, rate, notional, asset):
        ...
        if isinstance(asset, Asset):
            ...
            raise TypeError('Please enter an appropriate Asset class in the fourth parameter. Exiting...')
    ...
    def equity(self, t):
        ...
        '''
        assetValue = self._asset.value(t)
        balance = self.balance(t)
