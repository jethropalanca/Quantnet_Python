...
def main():
    ...
    try:
        ...
        print('\n' + name + ' is ' + str(age) + ' years old and lives in ' + country.upper() + '.')
    ...
    try:
        ...
        print('\n%s is %i years old and lives in %s.' %(name, age, country.upper()))
    ...
    try:
        ...
        print('\n{0} is {1} years old and lives in {2}.'.format(name, age, country.upper()))
    ...
    try:
        ...
        print('{a} is {b} years old and lives in {c}.'.format(a=name, b=age, c=country.upper()))
        print('{a} is {b} years old and lives in {c}.'.format(b=age, a=name, c=country.upper()))
        print('{a} is {b} years old and lives in {c}.'.format(c=country.upper(), b=age, a=name))
    ...
    try:
        ...
        print(f'\n{name} is {age} years old and lives in {country.upper()}.')
