...
def main():
    ...
    try:
        ...
        print('\n%s is %.1f years old and lives in %s.' % (name, age, country))
    ...
    try:
        ...
        print('\n{0} is {1:.1f} years old and lives in {2}.'.format(name, age, country))
    ...
    try:
        ...
        print('{a} is {b:.1f} years old and lives in {c}.'.format(a=name, b=age, c=country))
        print('{a} is {b:.1f} years old and lives in {c}.'.format(b=age, a=name, c=country))
        print('{a} is {b:.1f} years old and lives in {c}.'.format(c=country, b=age, a=name))
    ...
    try:
        ...
        print(f'\n{name} is {age:.1f} years old and lives in {country}.')
