...
from Exercise_4_3.Exercise_4_3_7.Loan_Package.house_base import HouseBase
import logging
...
class MortgageMixin(object):
    ...
    def __init__(self, term, rate, notional, home):
        ...
        if isinstance(home, HouseBase):
            ...
            logging.error('Please enter a home class in the fourth parameter. Exiting...')
            raise TypeError('Please enter a home class in the fourth parameter. Exiting...')
