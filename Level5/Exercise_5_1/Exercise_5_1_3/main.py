...
def main():
    ...
    try:
        ...
        logging.info('\na. Please the a date in the following format: YYYY mmmm dd h:m:s:ms AM/PM.\n')
        date = input('Please the a date in the following format: YYYY mmmm dd h:m:s:ms AM/PM (e.g. 2016 September 25 06:24:14:12342 PM).')

        # b. Create a datetime variable with the entered info.
        logging.info('\nb. Create a datetime variable with the entered info.')
        dt = datetime.datetime.strptime(date,'%Y %B %d %I:%M:%S:%f %p')
