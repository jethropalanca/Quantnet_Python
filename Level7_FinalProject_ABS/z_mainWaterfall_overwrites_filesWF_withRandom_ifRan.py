...
def main():
    ...
    logging.info('I. sequentialLiabsWF II. sequentialAssetWF III. prorataLiabsWF IV. prorataAssetWF')
    ...
    # filenames
    filenames = ['sequentialLiabsWF.csv', 'sequentialAssetWF.csv', 'prorataLiabsWF.csv', 'prorataAssetWF.csv']
